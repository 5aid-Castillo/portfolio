    ...
    <>
      <nav className="menu">
        ...
        <button className="menu-btn">
          <Hamburger
            toggled={mostrarBarra}
            toggle={setMostrarBarra}
            size={23}
            color="#ffff"
          />
        </button>
        <div
          className={
            mostrarBarra ? "navigation-menu" : "navigation-menu expanded"
          }
        >
          <HashLink onClick={close} to="#home">
            {idioma[language].Nhome}
          </HashLink>

          <HashLink onClick={close} to="#about">
            {idioma[language].Nabout}
          </HashLink>

          <HashLink onClick={close} to="#portfolio">
            {idioma[language].Nportfolio}
          </HashLink>

          <HashLink onClick={close} to="#contact">
            {idioma[language].Ncontact}
          </HashLink>
